        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-4 text-gray-600 text-lg">
                <p>
                  <strong className="text-gray-900">Marwen Helali</strong>, {t('about.founder.description')}
                </p>
                {t('about.founder.bio', { returnObjects: true }).map((paragraph, index) => (
                  <p key={index}>{paragraph}</p>
                ))}
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-gradient-to-br from-blue-100 to-cyan-100 p-8 rounded-2xl">
                ...
                <div className="text-center">
                  ...
                  <p className="text-blue-600 font-medium mb-4">{t('about.founder.position')}</p>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            {t('about.vision.pillars', { returnObjects: true }).map((pillar, index) => {
